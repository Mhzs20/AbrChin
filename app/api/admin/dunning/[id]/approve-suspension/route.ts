...
import { approveControlledSuspensionRequest } from "@/lib/billing/dunning";
import {
  jsonError,
  jsonOk,
  readIdempotencyKey,
...
export async function POST(
  ...
  try {
    ...
    return jsonOk(
      await approveControlledSuspensionRequest({
        dunningCaseId: id,
    ...
    return jsonError("تأیید Suspension ممکن نیست.", 500);
  }
}
