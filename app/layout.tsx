...
export const metadata: Metadata = {
  ...
  description:
    "ابرچین ابرها را برای یک شروع ساده، تحویل شفاف با پرچین پایه و رشد بدون بن‌بست می‌چیند.",
  ...
  openGraph: {
    ...
    description: "ساده شروع کن، با پرچین پایه شفاف تحویل بگیر و بدون بن‌بست رشد کن.",
    siteName: "ابرچین",
