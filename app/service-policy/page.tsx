  ...
  return (
    <section className="legal-page page-view" aria-labelledby="service-policy-title">
      <header className="page-heading">
        ...
        <p>
          این سند دامنه خدمت قابل‌اتکا در فاز فعلی را مشخص می‌کند؛ بدون وعده
          uptime تضمینی یا خدمات خارج از قرارداد پرچین.
        </p>
      </header>
      ...
      <div className="legal-prose">
        ...
        <p>
          سطح پرچین (شروع، فعال، پایدار) دامنه پشتیبانی را تعیین می‌کند. جزئیات
          هر سطح در صفحه <Link href="/support">سطح همراهی</Link> آمده است. خدمات
          خارج از فهرست «شامل می‌شود» — مانند مانیتورینگ ۲۴/۷ یا بکاپ
          مدیریت‌شده — فروخته یا تضمین نمی‌شود مگر صریحاً در همان قرارداد سطح
          آمده باشد.
        </p>
