    ...
    <section className="legal-page page-view" aria-labelledby="service-policy-title">
      ...
      <div className="legal-prose">
        ...
        <p>
          ...
          تعهد هر سطح نیز همان‌جا روشن است. تا وقتی مالک اجرا، موعد و شاهد
          قابل‌ممیزی همه تعهدها تأیید نشده باشد، آن سطح برای فروش عمومی نمایش
          داده نمی‌شود؛ درج یک عبارت در تنظیمات به‌تنهایی تضمین خدمت نیست.
        </p>
