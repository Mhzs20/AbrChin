...
const questions = [
  ...
  },
  {
    ...
    answer: "قابلیت حفاظتی ابرچینه؛ امن‌سازی، پایش، بکاپ و هشدارهای ضروری رو متناسب با سطح همراهی فعال می‌کنه.",
  },
  {
  ...
  },
  {
    ...
    answer: "بعد از پیشنهاد اولیه، موجودی و قیمت روز تأمین‌کننده بررسی می‌شه و قبل از خرید با تو تأییدش می‌کنیم.",
  },
];
