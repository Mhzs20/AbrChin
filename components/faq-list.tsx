...
const questions = [
  ...
  },
  {
    ...
    answer: "برای سرور ابری، Estimate ساعتی و ۲۴ساعته با Rate نسخه‌دار ساخته می‌شه. Invoice مصرف واقعی ممکنه Traffic یا Add-on قابل‌اندازه‌گیری داشته باشه. پلن‌های دوره‌ثابت قیمت Checkout جدا دارن.",
  },
];
