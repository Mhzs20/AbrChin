...
export function buildRecommendation(
  ...
  if (architectureEscalation) {
    caveats.unshift(
      downtime === "near_zero"
        ? "مهاجرت تقریباً بدون توقف به همگام‌سازی، تست Cutover و مسیر بازگشت نیاز دارد؛ خدمت همراهی در کنار سرور پیشنهاد می‌شود."
        : "برای این سطح حساسیت، همراهی معماری لازم است؛ با این حال یک سرور واقعی از فهرست ابرچین هم پیشنهاد می‌شود.",
    );
  }
